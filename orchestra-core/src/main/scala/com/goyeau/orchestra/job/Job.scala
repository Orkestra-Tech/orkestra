package com.goyeau.orchestra.job
...
import com.goyeau.orchestra.utils.{AutowireServer, Elasticsearch, ElasticsearchOutputStream}
import com.goyeau.orchestra.{kubernetes, CommonApiServer, OrchestraConfig}
